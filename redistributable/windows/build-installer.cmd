...
jpackage.exe ^
  ...
  --icon "package/windows/NearInfinity.ico" ^
  --file-associations "package/open_with.properties" ^
  --win-dir-chooser ^
  --win-per-user-install ^
  --win-shortcut ^
  --win-shortcut-prompt ^
  --win-menu ^
  --win-help-url "https://github.com/NearInfinityBrowser/NearInfinity/discussions" ^
  --about-url "https://github.com/NearInfinityBrowser/NearInfinity/wiki" || goto failed
ren "NearInfinity-%NI_VERSION%.exe" "NearInfinity-setup-win-%NI_VERSION%.exe" || goto failed
echo Installer successfully created: NearInfinity-setup-win-%NI_VERSION%.exe
goto completed
